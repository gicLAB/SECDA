...
int sc_main(int argc, char* argv[]) {
  ...
  float weight_local_usage = (float) (mg.weight_max_index+1)/ (float)WE_BUF_LEN *100;


  int total_batch_macs = mg.g1_macs;
  int total_out_count = mg.g1_out_count;
  ...
  cout << "Input Buffers Usage: "<< input_global_usage << "%" <<  endl;
  cout << "Weight Buffers Usage: "<< weight_local_usage << "%" <<  endl;
